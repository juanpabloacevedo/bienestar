      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="bienbenidoU.html">Usuario</a>
            </li>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="bienbenidoA.html">Administrador</a>
            </li>
            </li>
            <li class="nav-item active">
    ...
    <div class="col-md-9">
      <div class="card">
        <div class="card-body text-center align-content-center align-items-center">
          ...
          <br/>
          <div class="col-md-12  ">
            <img src="../../dist/img/Gimnasios_USTA_Tunja.jpg" class="img img-fluid  align-items-center" alt="GYM"  >
          </div>
