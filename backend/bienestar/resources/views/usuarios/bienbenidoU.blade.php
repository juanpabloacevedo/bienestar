  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand" href="http://www.ustatunja.edu.co"><img src="../../dist/img/Logo_2019_Universidad_Santo_Tomas.png"class="img img-fluid" alt="logo" style="width: 25%"></a>
...
<div class="container" id="login">
 ...
 <br/>
          <li class="nav-item form-control form-group">
            <a class="nav-link" href="actividadesUsuario.html">Actividades</a>
          </li>
          <li class="nav-item form-control form-group">
          ...
          <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../../dist/img/Gimnasios_USTA_Tunja.jpg" class="d-block w-100 img img-fluid align-items-center" alt="GYM">
              </div>
              <div class="carousel-item">
                <img src="../../dist/img/Gimnasio_al_Patio_USTA_Tunja.jpg" class="d-block w-100 img img-fluid align-items-center" alt="GYM">
              </div>
              <div class="carousel-item">
                <img src="../../dist/img/Logo_2019_Universidad_Santo_Tomas.png" class="d-block w-100 img img-fluid align-items-center" alt="GYM">
              </div>
            </div>
          </div>
          <br/>
